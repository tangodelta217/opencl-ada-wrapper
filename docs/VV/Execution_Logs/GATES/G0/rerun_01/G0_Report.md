# Gate G0 Report (Rerun 01)

- UTC timestamp: 2026-02-09T12:11:21Z
- Commit (HEAD): 772ece178436133f629f16df3025a8cad8e05a97
...
Compile
   [Ada]          smoke_platforms.adb
opencl-raw-api.ads:22:04: error: representation item not permitted before Ada 2022
opencl-raw-api.ads:22:04: error: parent type "Address" has primitive operations
opencl-raw-api.ads:23:04: error: representation item not permitted before Ada 2022
opencl-raw-api.ads:23:04: error: parent type "Address" has primitive operations
opencl-raw-api.ads:53:45: error: operator for type "Interfaces.C.int" is not directly visible
opencl-raw-api.ads:53:45: error: use clause would make operation legal
opencl-raw-api.ads:54:51: error: operator for type "Interfaces.C.int" is not directly visible
opencl-raw-api.ads:54:51: error: use clause would make operation legal
opencl-raw-api.ads:60:04: error: "CL_DEVICE_TYPE" conflicts with declaration at line 18
...
- `docs/VV/Execution_Logs/GATES/G0/rerun_01/01_repo_layout.log`
- `docs/VV/Execution_Logs/GATES/G0/rerun_01/02_toolchain.log`
- `docs/VV/Execution_Logs/GATES/G0/rerun_01/03_build.log`
- `docs/VV/Execution_Logs/GATES/G0/rerun_01/04_smoke.log`
