# Gate G4 Report (rerun_01)

- UTC timestamp: 2026-02-10T00:32:45Z
- git rev-parse HEAD: c7c51a498487b6d1592f4079bafe8e06cff410b2
...
## Run (tools/run_smoke.sh)

```text
$ tools/run_smoke.sh
=== Build Start ===
timestamp_utc=20260210T003251Z
...
build_log=/home/tangodelta/opencl-ada-wrapper/docs/VV/Execution_Logs/local/20260210T003251Z_build.log
=== Build End ===
=== Smoke Run Start ===
timestamp_utc=20260210T003251Z
repo_root=/home/tangodelta/opencl-ada-wrapper
...
INFO binary_fnv1a32=972143198
RESULT=PASS
smoke_program_binary_roundtrip_exit_code=0
smoke_exit_code=0
smoke_log=/home/tangodelta/opencl-ada-wrapper/docs/VV/Execution_Logs/local/20260210T003251Z_smoke_run.log
=== Smoke Run End ===
```

## Extracted Evidence (smoke_program_binary_roundtrip)
...
- docs/VV/Execution_Logs/GATES/G4/rerun_01/01_build.log
- docs/VV/Execution_Logs/GATES/G4/rerun_01/02_run_smoke.log
