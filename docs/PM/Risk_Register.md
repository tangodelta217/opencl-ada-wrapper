...
| OCLW-RSK-0011 | Integridad (hash) != autenticidad (firma): el hash detecta tamper accidental, pero no garantiza origen confiable | Media | Alta | Gate G7/G8: firma/verificacion con proveedor criptografico aprobado; aplicar fail-closed en RT ante firma ausente/invalida | <TBD_OWNER> | Abierto |
