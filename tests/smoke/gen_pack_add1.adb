...
begin
   ...
   begin
      if not Ada.Directories.Exists (Pack_Dir) then
         Ada.Directories.Create_Path (New_Directory => Pack_Dir);
      end if;
      ...
      if not Failed then
         ...
         begin
            ...
            Meta.Pack_Id := Packs.To_Bounded ("kpack_add1");
            ...
            if not Failed then
               ...
               Meta.Build_Options := Packs.To_Bounded (Build_Options);
               Meta.Kernel_Name := Packs.To_Bounded ("add1");
